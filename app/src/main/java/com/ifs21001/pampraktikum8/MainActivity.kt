...
import com.ifs21001.pampraktikum8.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
        ...
        binding.inAppBar.bottomNavView.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.navigation_status -> {
                    loadFragment(FLAG_FRAGMENT_STORY)
                    true
                }
    ...
    private fun loadFragment(flag: String, message: String? = null) {
        ...
        when (flag) {
            ...
            FLAG_FRAGMENT_STORY -> {
                ...
                val fragment = fragmentManager
                    .findFragmentByTag(StoryFragment::class.java.simpleName)
                if (fragment !is DashboardFragment) {
                    fragmentManager
                        .beginTransaction()
                        .replace(
    ...
    companion object {
        ...
        const val FLAG_FRAGMENT_STORY = "fragment_story"
    }
}
